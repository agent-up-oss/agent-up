...
public class LocalInstallerNuGetPackagingTests
{
    ...
    private static void DotnetPack(string solutionRoot, string outputDir)
    {
        string[] projects =
        [
            Path.Join("LocalInstaller.Core", "LocalInstaller.Core.csproj"),
            Path.Join("LocalInstaller.App", "LocalInstaller.App.csproj"),
            Path.Join("LocalInstaller.Smoke", "LocalInstaller.Smoke.csproj"),
            Path.Join("LocalInstaller.Packaging", "LocalInstaller.Packaging.csproj"),
        ];
