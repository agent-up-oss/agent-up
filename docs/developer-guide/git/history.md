...
<DocSurfaces>
<DocSurface desktop>The Git tab History page shows a denser Server-owned commit history with parent-lane glyphs; a labeled branch ref checks it out through the Server.</DocSurface>
