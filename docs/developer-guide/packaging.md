...
- Noninteractive core-app installation through `AgentUp.InstallerApp --install-core --payload-root <payload-root>` for smoke tests and CI workflows that must exercise the shipped installer executable without driving pointer clicks.
