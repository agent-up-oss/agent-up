...
<DocWhat>
History is a bounded commit log for the workspace. Desktop and Mobile both open it from the Git tab.
</DocWhat>

<DocSurfaces>
<DocSurface desktop>The Git tab History page shows a bounded commit history with a simple parent-lane graph. Choosing a labeled branch ref from that history checks it out the same way as the branch dropdown.</DocSurface>
