...
public class UbuntuPackageValidatorTests
{
    ...
    private static void CreateUbuntuRoot(string root)
    {
        ...
        WriteText(Path.Join(root, "usr", "share", "metainfo", "agent-up.metainfo.xml"), "<component><id>agent-up-installer.desktop</id><provides><pkgname>agent-up</pkgname></provides><releases><release version=\"1.0.0\" date=\"2026-01-01\"/></releases></component>\n");
