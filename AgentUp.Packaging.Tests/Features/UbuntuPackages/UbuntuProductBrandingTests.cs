...
{
    private static readonly ProductManifest AcmeStudio = new("Acme Studio", "acme-studio", "ACMESTUDIO");
    ...
    public async Task BuildDebAsync_forAgentUpManifest_commandShapeMatchesBaseline()
    {
        ...
        var layout = UbuntuPackageLayout.From(request, ProductManifest.AgentUp());
