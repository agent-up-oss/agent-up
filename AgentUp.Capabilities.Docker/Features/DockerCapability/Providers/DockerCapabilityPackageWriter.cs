...
public sealed class DockerCapabilityPackageWriter
{
    ...
    public void Write(string packageDirectory, CapabilityPackageManifest manifest, string defaultNix, string moduleDirectory)
    {
        ...
        CopyModule(packageDirectory, moduleDirectory, manifest.Module, "AgentUp.Sdk.Common.dll", "AgentUp.Sdk.Runtime.dll");
    }
