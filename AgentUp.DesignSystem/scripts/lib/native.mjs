...
const textKeys = new Set(['color', 'fontSize', 'fontWeight', 'opacity', 'fontFamily', 'fontStyle', 'textTransform', 'letterSpacing', 'whiteSpace']);
  ...
  for (const [property, value] of declarations) {
    ...
    switch (property) {
      ...
      case 'min-width':
        ...
        break;
      case 'margin-left':
        style.marginLeft = nativeLiteral(value, tokens);
        break;
      case 'max-width':
        style.maxWidth = nativeLiteral(value, tokens);
        break;
      case 'width':
        if (value.includes('%') || value.includes('min(') || /fit-content|max-content|min-content|auto/.test(value)) break;
        style.width = nativeLiteral(value, tokens);
        break;
      case 'height':
      ...
      case 'font-family':
        ...
        break;
      case 'font-style':
        style.fontStyle = value === 'italic' || value === 'oblique' ? "'italic'" : "'normal'";
        break;
      case 'font-weight': {
