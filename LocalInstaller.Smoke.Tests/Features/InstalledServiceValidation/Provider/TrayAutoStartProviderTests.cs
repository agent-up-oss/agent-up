...
public sealed class TrayAutoStartProviderTests
{
    ...
    public void WindowsValidationCommand_comparesRunValueToExpectedTrayExecutable()
    {
        ...
        Assert.That(command.Environment!["LOCALINSTALLER_TRAY_AUTOSTART_NAME"], Is.EqualTo("Agent-Up"));
        Assert.That(command.Environment!["LOCALINSTALLER_TRAY_AUTOSTART_VALUE"], Is.EqualTo($"\"{trayExecutable}\""));
    }
