...
| `AgentUp.Registry` | Local-directory store and remote HTTP catalog for versioned capability packages. Not workspace orchestration; Server remains source of truth for enablement and launches |
