...
// Snapshot of everything StreamStateDerivation needs to compute a StreamState.
// Populated by WorkspaceStreamStateService in the host application; passed to
// StreamStateDerivation.Compute() which has no side effects.
public sealed record WorkspaceStreamInputs
{
...
public sealed record CurrentStreamTarget(string? AppName, int Port, string Url, bool HealthChecked);
