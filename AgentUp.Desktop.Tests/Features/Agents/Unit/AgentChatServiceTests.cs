...
internal sealed class FakeAgentApiProvider : IAgentApiProvider
{
    ...
    public async IAsyncEnumerable<AgentEventDto> EventsAsync(string workspaceId, long after, CancellationToken cancellationToken) { await Task.CompletedTask; yield break; }
}
