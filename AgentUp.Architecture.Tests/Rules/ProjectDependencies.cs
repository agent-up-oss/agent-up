...
public sealed class ProjectDependencies
{
    ...
    public void Production_project_dependencies_follow_ownership_boundaries()
    {
        ...
        AssertDoesNotDependOn("AgentUp.Server", Except("AgentUp.Server", "AgentUp.CommitPolicy", "AgentUp.Capabilities.Abstractions", "AgentUp.Capabilities.Dotnet", "AgentUp.Capabilities.Docker", "AgentUp.Capabilities.Codex", "AgentUp.Capabilities.Cursor", "AgentUp.Capabilities.Claude"));
