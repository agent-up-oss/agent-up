...
const styles = StyleSheet.create({
  ...
  savedRowActive: { borderColor: '#2bf27a', backgroundColor: '#08150d' },
  savedButton: { flex: 1, gap: 4 }, savedUrl: { color: '#f5fbf7', fontWeight: '700' }, savedMeta: { color: '#9fb2a8', fontSize: 12 },
  removeButton: { minHeight: 40, justifyContent: 'center', paddingHorizontal: 8 }, removeText: { color: '#ff6b6b', fontWeight: '700' },
});
