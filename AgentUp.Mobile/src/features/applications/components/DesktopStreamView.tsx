...
const styles = StyleSheet.create({ native: { flex: 1, backgroundColor: agentUpTheme.colors.canvas } });
const webStyle = { width: '100%', height: '100%', border: 0, background: agentUpTheme.colors.canvas };
