...
public sealed class AgentUpContextProvider : IAgentUpContextProvider
{
    ...
    public string GetAgentUpJsonFormat() =>
        ...
        If agent-up.json is missing, inspect docs/user-docs/configuration/index.md, search the repository for an existing agent-up.json, or ask the user before creating one.
        """;
}
