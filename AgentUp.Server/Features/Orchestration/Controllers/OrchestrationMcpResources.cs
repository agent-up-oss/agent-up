...
public sealed class OrchestrationMcpResources
{
    ...
    public OrchestrationMcpResources(OrchestrationWorkspaceController workspaces, OrchestrationContextController context)
    {
