...
public sealed class AgentsController(AgentSchedulingService scheduling, AgentEventService events)
{
    ...
    public Task<bool> PromptAsync(string workspaceId, string message, CancellationToken cancellationToken) => scheduling.PromptAsync(workspaceId, message, cancellationToken);
    public Task<bool> CancelAsync(string workspaceId, CancellationToken cancellationToken) => scheduling.CancelAsync(workspaceId, cancellationToken);
    public Task<bool> StopAsync(string workspaceId, CancellationToken cancellationToken) => scheduling.StopAsync(workspaceId, cancellationToken);
