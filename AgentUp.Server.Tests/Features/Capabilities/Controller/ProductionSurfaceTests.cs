...
{
    private static readonly Type ProductionType = Assembly.Load("AgentUp.Server").GetType("AgentUp.Server.Features.Capabilities.Controllers.CapabilitiesController")!;
