...
{
    private static readonly Type ProductionType = Assembly.Load("AgentUp.Server").GetType("AgentUp.Server.Features.Processes.Controllers.ProcessesController")!;
    ...
    public void Required_controllers_type_keeps_its_feature_namespace()
        => Assert.That(ProductionType.Namespace, Does.Contain(".Features.Processes."));
}
