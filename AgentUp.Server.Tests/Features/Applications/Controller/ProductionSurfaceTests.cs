...
{
    [TestCase("AgentUp.Server.Features.Applications.Controllers.AppHealthController")]
    [TestCase("AgentUp.Server.Features.Applications.Controllers.AppMetricsController")]
